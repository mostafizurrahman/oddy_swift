...
class SubscriptionViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.logoView.layer.cornerRadius = 50
        ...
        DispatchQueue.main.async {
            ...
            if let userInfo = notification.userInfo as? [String:String],
                ...
                if key.elementsEqual(SM.READ) {
                    ...
                    let _alert = UIAlertController(title: "SUBSCRIBED", message: "Your subscription to the ODDY was success!", preferredStyle: UIAlertController.Style.alert)
                    let _action = UIAlertAction(title: "DISMISS", style: UIAlertAction.Style.default) { (_) in
